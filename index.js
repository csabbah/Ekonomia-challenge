...
var fetchQuery = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                client = new graphql_request_1.GraphQLClient('https://api.thegraph.com/subgraphs/name/nmimran99/compound');
            ...
            case 2:
                ...
                return [3 /*break*/, 1];
            case 3:
                console.log("Number of positions with interest paid - ".concat(allData.length));
