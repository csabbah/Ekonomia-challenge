...
var client = new graphql_request_1.GraphQLClient('https://api.thegraph.com/subgraphs/name/nmimran99/compound');
var returnResult = function () { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.request(query)];
            case 1:
                result = _a.sent();
                console.log("Number of positions with interest paid - ".concat(result.positions.length));
